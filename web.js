...
(function ($) {
    class $hyoo_intern extends $mol_book2_catalog {
        ...
        Vacancies() {
            const obj = new this.$.$mol_page();
            obj.title = () => "Список вакансий";
            return obj;
        }
        Applications() {
            const obj = new this.$.$mol_page();
            obj.title = () => "Мои заявки";
            return obj;
        }
        Invitations() {
            const obj = new this.$.$mol_page();
    ...
    __decorate([
        $mol_mem
    ], $hyoo_intern.prototype, "Description", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $hyoo_intern.prototype, "Vacancies", null);
    __decorate([
        $mol_mem
    ], $hyoo_intern.prototype, "Applications", null);
    __decorate([
        $mol_mem
